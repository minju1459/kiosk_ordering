...
class TeabanaFragment : BindingFragment<FragmentTeabanaBinding>(R.layout.fragment_teabana) {
    ...
    private fun getItems(): List<Item> {
        return listOf(
            Item(R.drawable.img_hot_mint, "(HOT]민트 블렌드 티", 4700, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_ice_mint, "(ICE)민트 블렌드 티", 4700, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_ergray_tea, "(ICE)얼 그레이 티", 5400, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_useberry, "(ICE)유스베리 티", 5500, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_yuza, "(ICE)유자 민트 티", 6500, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_ice_english, "(ICE)잉글리쉬 브렉퍼스트 티", 4800, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_ergray_hot, "(HOT)얼 그레이 티", 5900, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_useberry, "(HOT)유스베리 티", 4900, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_hibiscus, "(HOT)히비스커스 블렌드 티", 4800, 1, "Tall Size", "", "", ""),
            Item(R.drawable.img_snow_malcha, "(ICE)스노우 말차 라떼", 5700, 1, "Tall Size", "", "", ""),
        )
    }
}
